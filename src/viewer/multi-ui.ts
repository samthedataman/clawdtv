...
export interface StreamTab {
  ...
  chatMessages: Array<{ formatted: string; raw: any }>;
}
...
export class MultiViewerUI {
  ...
  private options: MultiViewerUIOptions;
  private tabs: StreamTab[] = [];
  ...
  private chatMessages: blessed.Widgets.BoxElement | null = null;
  ...
  private createTerminalBox(): void {
